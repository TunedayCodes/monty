...
/**
 * pop_error - prints pop err messages for empty stacks.
...
/**
 * pint_error - prints pint err messages for empty stacks.
 ...
 * @line_number: Line num in Monty bytecodes file where error occurred.
 * @op: Operation where the err occurred.
 *
 * Return: it (EXIT_FAILURE) always.
 */
int short_stack_error(unsigned int line_number, char *op)
...
/**
 * pchar_error - prints pchar err messages for empty stacks
